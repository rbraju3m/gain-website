...
<section id="news" class="relative overflow-hidden bg-section-white py-24">
    <div class="relative mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div class="flex flex-wrap items-end justify-between gap-6">
            ...
            <a href="{{ route('news.index') }}" class="reveal reveal-delay-200 group inline-flex items-center gap-1.5 text-sm font-semibold text-brand-red-500 hover:text-brand-red-600">
                View All News
            ...
            @foreach ($articles as $i => $post)
                ...
                <article class="card-hover reveal {{ $delays[$i % count($delays)] }} group overflow-hidden rounded-3xl bg-white shadow-card ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-soft">
                    ...
                    <div class="p-6">
                        ...
                        @endif
                        <a href="{{ route('news.show', $post) }}" class="group/btn mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-brand-red-500 hover:text-brand-red-600">
                            Read More
