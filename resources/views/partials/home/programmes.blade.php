            ...
            @foreach ([
                ...
                <article class="reveal {{ $delays[$i] }} group overflow-hidden rounded-3xl bg-white shadow-card ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-soft">
                    <div class="img-zoom relative">
                        ...
                        {{-- bottom shading helps the badge stay readable on bright photos --}}
                    ...
                    <div class="p-7">
                        ...
                        <a href="#" class="group/btn mt-5 inline-flex items-center gap-1.5 rounded-full bg-brand-cream px-5 py-2 text-sm font-semibold text-brand-red-500 transition hover:bg-brand-red-100">
                            Learn More
