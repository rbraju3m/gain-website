<footer class="bg-brand-red-700 text-white">
    <div class="mx-auto grid max-w-7xl gap-10 px-6 py-16 sm:grid-cols-2 lg:grid-cols-4 lg:px-10">
        ...
        <div>
            ...
            <p class="mt-4 text-sm text-white/70">
                Dedicated to improving nutrition and food security for families across Bangladesh through sustainable programmes and community empowerment.
            </p>
            <div class="mt-6 flex items-center gap-3">
                @foreach ([
                    ['label' => 'Facebook',  'path' => 'M22 12a10 10 0 1 0-11.6 9.9v-7H8v-3h2.4V9.5C10.4 7 11.9 6 14 6c.9 0 1.8.2 1.8.2v2h-1c-1 0-1.3.6-1.3 1.3V12H16l-.4 3H13.5v7A10 10 0 0 0 22 12Z'],
                    ['label' => 'Twitter',   'path' => 'M22 5.8c-.7.3-1.5.5-2.4.6.9-.5 1.5-1.3 1.8-2.2-.8.5-1.7.8-2.6 1A4.1 4.1 0 0 0 12 9c0 .3 0 .6.1.9-3.4-.2-6.4-1.8-8.4-4.3-.4.6-.6 1.3-.6 2.1 0 1.5.7 2.7 1.8 3.5-.7 0-1.3-.2-1.9-.5v.1c0 2 1.4 3.6 3.3 4-.4.1-.7.2-1.1.2-.3 0-.5 0-.8-.1.5 1.7 2 2.9 3.8 2.9A8.2 8.2 0 0 1 2 19.6 11.6 11.6 0 0 0 8.3 21c7.6 0 11.7-6.3 11.7-11.7v-.5c.8-.6 1.5-1.3 2-2Z'],
                    ['label' => 'LinkedIn',  'path' => 'M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2ZM8.4 18H5.6V10h2.8v8ZM7 8.7a1.6 1.6 0 1 1 0-3.3 1.6 1.6 0 0 1 0 3.3ZM18.4 18h-2.8v-4.1c0-1-.4-1.6-1.3-1.6-.8 0-1.2.5-1.4 1.1V18h-2.8v-8h2.7v1.2a3 3 0 0 1 2.6-1.4c1.9 0 3 1.3 3 3.7V18Z'],
                ] as $s)
                    <a href="#" aria-label="{{ $s['label'] }}" class="grid h-9 w-9 place-items-center rounded-full bg-white/10 transition hover:bg-white/20">
        ...
        <div>
            ...
            <ul class="mt-4 space-y-3 text-sm text-white/70">
                <li class="flex items-start gap-2">
                    ...
                    <span>House 12, Road 7,<br>Dhanmondi, Dhaka–1205, Bangladesh</span>
                </li>
    ...
    <div class="border-t border-white/10 bg-brand-red-800/30">
        <div class="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 px-6 py-5 text-xs text-white/60 lg:px-10">
            <p>© {{ date('Y') }} Gain Foundation Bangladesh. All rights reserved.</p>
