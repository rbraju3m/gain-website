        ...
        <div class="relative mx-auto max-w-3xl px-6 text-center lg:px-10">
            <div class="reveal mx-auto grid h-20 w-20 place-items-center rounded-full bg-brand-red-100 text-brand-red-500">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" class="h-10 w-10">
                    <path d="M9.7 14.3a3 3 0 0 1 4.6 0M9 9h.01M15 9h.01M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Z"/>
                </svg>
            </div>
            ...
            <p class="reveal reveal-delay-200 mx-auto mt-4 max-w-xl text-brand-muted">
                The link may have moved, or it might never have existed. Try one of the routes below — or head back to the homepage.
            </p>
            ...
            <div class="reveal reveal-delay-300 mt-8 flex flex-wrap items-center justify-center gap-3">
                ...
                <a href="{{ route('programmes.index') }}" class="inline-flex items-center gap-2 rounded-full border border-brand-ink/15 bg-white px-6 py-3 text-sm font-semibold text-brand-ink hover:border-brand-ink/30 hover:bg-brand-red-50">
                    Programmes
                </a>
                <a href="{{ route('news.index') }}" class="inline-flex items-center gap-2 rounded-full border border-brand-ink/15 bg-white px-6 py-3 text-sm font-semibold text-brand-ink hover:border-brand-ink/30 hover:bg-brand-red-50">
                    News &amp; Events
                </a>
