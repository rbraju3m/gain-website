...
@section('content')
    ...
    {{-- Above-fold: clean white editorial hero --}}
    ...
    {{-- Body: single centred prose column --}}
            ...
            <div class="reveal mt-14 border-t border-brand-cream pt-8">
                <div class="flex flex-wrap items-center justify-between gap-6">
                    <div class="text-xs uppercase tracking-[0.18em] text-brand-muted">
                        @if ($programme->category) Programme · {{ $programme->category }} @else Programme @endif
                    </div>
